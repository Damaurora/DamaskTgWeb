  ...
  return (
    <section className={containerClass} id="products">
      ...
      <div className="categories-carousel flex overflow-x-auto gap-3 pb-4">
        ...
        >
          <div className={`w-16 h-16 rounded-full ${currentSlug === undefined && window.location.pathname === '/' ? 'bg-primary/30' : 'bg-[hsl(var(--light-bg))]'} flex items-center justify-center hover:bg-primary/20 transition-colors`}>
